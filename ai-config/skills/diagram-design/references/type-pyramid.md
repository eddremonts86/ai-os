...
- Each layer has:
  ...
  - **Sublabel** below or beside the name — JetBrains Mono 9–10px.
...
- **Acid accent on ONE layer only**: apex of pyramid, conversion layer of funnel, or critical bottleneck.
- Optional left-margin axis arrow + JetBrains Mono label (`rarer ↑`, `drop-off ↓`).
...
- Acid accent on the base layer (dilutes the "apex = rare" signal).
