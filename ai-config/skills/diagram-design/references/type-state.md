...
- Transitions: curved arrows labeled in JetBrains Mono as `event [guard] / action` (omit sections you don't need).
...
- Acid accent on the state the reader should notice — typically the error state, or "happy completion".
