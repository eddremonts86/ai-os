...
- Nodes are small labeled rectangles (`rx=6`), Geist 12px 600 name + optional JetBrains Mono 9px sublabel. Width 120–180px, height 40–52px.
...
- Acid accent on **one** node: root OR critical leaf. Not both.
...
- Acid accent on root AND a leaf.
