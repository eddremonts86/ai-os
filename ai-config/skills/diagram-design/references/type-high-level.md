...
Fills alternate `#f4f5f9` / `#3d4460` (light mode) or `#3d4460` / `#4a5270` (dark mode). Labels: paper-colored mono `font-size=7`, `letter-spacing=0.14em`, `text-anchor=middle`, centered at `chevron_cx, 21`.
...
Stroke: `rgba(244,245,249,0.20)`, `stroke-width=0.8`, `stroke-dasharray=6,3`, `rx=6`. Zone fill: `rgba(244,245,249,0.02)`.
...
Stroke: `rgba(244,245,249,0.18)`, `stroke-width=1.2`, `rx=8`. Fill: `rgba(244,245,249,0.02)`. K8s icon + label at `(cluster_x + 16, 352)` (icon) and `(cluster_x + 40, 362)` (text).
...
Stroke: `rgba(244,245,249,0.20)`, `stroke-width=0.8`, `rx=6`. Fill: `rgba(244,245,249,0.05)`. Icon at `(16, cross_y(k) + 10)`, name centered at `(effective_w / 2, cross_y(k) + 22)`, subtitle at `(effective_w / 2, cross_y(k) + 34)`.
...
Stroke: `rgba(244,245,249,0.18)`, `stroke-width=0.8`, `rx=4`. Fill: `rgba(244,245,249,0.05)`. Tool icon at the far right (`bar_x + bar_w - 50, 58`); name centered at `(bar_x + bar_w/2, 71)`; subtitle at `(bar_x + bar_w/2, 84)`.
...
**Focal node:** `fill="rgba(179,238,85,0.08)"`, `stroke="#b3ee55"`, `stroke-width=1.2`. Title text in accent color. All other nodes: white fill, `stroke=rgba(244,245,249,0.25)`, `stroke-width=1`.
...
Fills alternate `#f4f5f9` / `#3d4460` (same palette as horizontals). Labels: paper-colored mono `font-size=7`, `letter-spacing=0.14em`, **rotated −90°**, anchored at `(strip_x + strip_w/2, (y0+y1)/2)`.
...
|---|---|---|---|---|---|
| `primary` | `#b3ee55` | 1.2 | — | `arrow-accent` | Every edge whose endpoint is the `focal` node. |
| `secondary` | `#a2a4ae` | 1.0 | — | `arrow` | Default for source→component and component→component when neither endpoint is focal. |
| `trigger` | `#a2a4ae` | 1.0 | `4,3` | `arrow-sm` | Every edge originating from a `kind: bar` component. |
| `query` | `rgba(244,245,249,0.30)` | 1.0 | `4,3` | `arrow` | Read-back edges (e.g., focal ↔ Trino). |
...
| Token | Light | Dark |
|---|---|---|
| Page paper | `#08090e` | `#1c1f2e` |
| Ink | `#f4f5f9` | `#08090e` |
| Muted text | `#a2a4ae` | `rgba(8,9,14,0.65)` |
| Chevron dark fill | `#f4f5f9` | `#3d4460` |
| Chevron light fill | `#3d4460` | `#4a5270` |
| Chevron label | `#08090e` | `#08090e` (unchanged) |
| Dashed border | `rgba(244,245,249,0.20)` | `rgba(8,9,14,0.22)` |
| Cluster border | `rgba(244,245,249,0.18)` | `rgba(8,9,14,0.18)` |
| Node fill | white | `rgba(8,9,14,0.06)` |
| Node stroke | `rgba(244,245,249,0.25)` | `rgba(8,9,14,0.20)` |
| Focal fill | `rgba(179,238,85,0.08)` | `rgba(179,238,85,0.12)` |
| Focal stroke | `#b3ee55` | `#b3ee55` |
| Accent connector | `#b3ee55` | `#b3ee55` |
| Dot pattern | `rgba(244,245,249,0.10)` | `rgba(8,9,14,0.10)` |
