...
- Tick marks at time boundaries (quarters, months, sprints) with date labels below in JetBrains Mono.
...
- Major milestones: acid accent circle (`r=6`) + bold Geist label.
