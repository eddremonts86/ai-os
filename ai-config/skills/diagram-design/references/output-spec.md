...
| Sublabel (JetBrains Mono) | 9 | 12 | 9 |
| Arrow label (JetBrains Mono) | 8 | 12 | 8 |
| Eyebrow / tag (JetBrains Mono) | 8 | 8 | 8 |
...
For mono sublabels use `'JetBrains Mono', 'Noto Sans Mono CJK JP', monospace`. CJK glyphs render ~10% wider than Latin at the same size — budget box width accordingly, and prefer 12px names over 8px sublabels for CJK, which goes muddy below 10px.
