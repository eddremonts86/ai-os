# TASKS.md — What are the best companies to have a business relationship with? (i will not promote)

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/278-what-are-the-best-companies-to-have-a-business-relation/`
