...
_Based on source brief:_ # There are many factories, but this one's yoursAll coding harnesses and code factories have a few major flaws:
...
_Source:_ [ProblemHunt](https://news.ycombinator.com/item?id=49342987) · **Category:** show-hn · **Tags:** Show HN,Product,Problem
