# TASKS.md — A Fiverr animator ghosted us, so we made this product animation with 3 prompts and one HTML file

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/251-a-fiverr-animator-ghosted-us-so-we-made-this-product-an/`
