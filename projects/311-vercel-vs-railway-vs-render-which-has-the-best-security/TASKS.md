# TASKS.md — Vercel vs Railway vs Render: Which has the best security?

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/311-vercel-vs-railway-vs-render-which-has-the-best-security/`
