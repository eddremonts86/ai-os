---
id: "2416"
slug: development-mindset-for-ai-programming
title: Development Mindset for AI Programming
status: draft
source:
  name: manual
...
- [ ] Copiar `edd-app-template` → `apps/2416-development-mindset-for-ai-programming/`
