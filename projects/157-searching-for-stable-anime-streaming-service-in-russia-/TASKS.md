# TASKS.md — Searching for stable anime streaming service in Russia without VPN requirement

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/157-searching-for-stable-anime-streaming-service-in-russia-/`
