# TASKS.md — No access to mentors from real experts to start in the real estate field

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/092-no-access-to-mentors-from-real-experts-to-start-in-the-/`
