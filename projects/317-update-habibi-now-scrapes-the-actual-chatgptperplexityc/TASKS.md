# TASKS.md — update: habibi now scrapes the actual chatgpt/perplexity/claude apps too, not just apis (and it's cheaper now)

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/317-update-habibi-now-scrapes-the-actual-chatgptperplexityc/`
