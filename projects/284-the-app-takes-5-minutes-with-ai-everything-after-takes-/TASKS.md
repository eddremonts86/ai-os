# TASKS.md — The app takes 5 minutes with AI. Everything after takes months. I will not promote

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/284-the-app-takes-5-minutes-with-ai-everything-after-takes-/`
