# TASKS.md — A ready-made platform for robotics prototyping cannot create an active user community

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/149-a-ready-made-platform-for-robotics-prototyping-cannot-c/`
