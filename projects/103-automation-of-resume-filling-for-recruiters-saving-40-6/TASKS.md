# TASKS.md — Automation of resume filling for recruiters — saving 40-60 minutes on each candidate

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/103-automation-of-resume-filling-for-recruiters-saving-40-6/`
