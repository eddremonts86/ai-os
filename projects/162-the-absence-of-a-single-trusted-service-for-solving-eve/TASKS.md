# TASKS.md — The absence of a single trusted service for solving everyday tasks

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/162-the-absence-of-a-single-trusted-service-for-solving-eve/`
