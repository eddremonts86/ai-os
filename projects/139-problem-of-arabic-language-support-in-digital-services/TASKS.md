# TASKS.md — Problem of arabic language support in digital services

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/139-problem-of-arabic-language-support-in-digital-services/`
