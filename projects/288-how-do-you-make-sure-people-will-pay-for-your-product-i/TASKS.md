# TASKS.md — How do you make sure people will pay for your product? (I will not promote)

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/288-how-do-you-make-sure-people-will-pay-for-your-product-i/`
