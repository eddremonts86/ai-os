# TASKS.md — Inability to get a response to complaints from companies

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/109-inability-to-get-a-response-to-complaints-from-companie/`
