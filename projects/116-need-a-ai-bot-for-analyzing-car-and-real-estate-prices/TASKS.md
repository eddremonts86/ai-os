# TASKS.md — Need a AI-bot for analyzing car and real estate prices

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/116-need-a-ai-bot-for-analyzing-car-and-real-estate-prices/`
