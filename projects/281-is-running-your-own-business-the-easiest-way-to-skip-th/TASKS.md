# TASKS.md — Is running your own business the easiest way to skip the job hunt later? (I will not promote)

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/281-is-running-your-own-business-the-easiest-way-to-skip-th/`
