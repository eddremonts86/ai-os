# TASKS.md — Need for a niche marketplace for Tilda code blocks and solutions

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/190-need-for-a-niche-marketplace-for-tilda-code-blocks-and-/`
