# TASKS.md — Protection against fraudulent schemes in trading and cryptocurrency investments

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/104-protection-against-fraudulent-schemes-in-trading-and-cr/`
