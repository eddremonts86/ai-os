# TASKS.md — Career shift - advice needed on how to land a job in SaaS sales

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/324-career-shift-advice-needed-on-how-to-land-a-job-in-saas/`
