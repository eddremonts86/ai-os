# TASKS.md — Need for a service to package website deliveries professionally

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/179-need-for-a-service-to-package-website-deliveries-profes/`
