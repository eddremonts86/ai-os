# TASKS.md — Need for a unified Tilda extension combining Nolim and Annexx features

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/194-need-for-a-unified-tilda-extension-combining-nolim-and-/`
