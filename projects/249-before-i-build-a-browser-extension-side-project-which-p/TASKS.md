# TASKS.md — Before I build a browser-extension side project: which problem has real pull?

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/299-before-i-build-a-browser-extension-side-project-which-p/`
