# TASKS.md — I've spent $150k on therapy and I can't remember half of it

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/252-ive-spent-150k-on-therapy-and-i-cant-remember-half-of-i/`
