# TASKS.md — I built a tool that shows you how much each User is actually costing you

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/270-i-built-a-tool-that-shows-you-how-much-each-user-is-act/`
