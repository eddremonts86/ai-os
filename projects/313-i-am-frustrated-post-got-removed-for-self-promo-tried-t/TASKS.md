# TASKS.md — I am frustrated! Post got removed for self-promo, tried to reframe it, now I'm getting bashed for &quot;stealth marketing.&quot; I just wanted feedback.

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/313-i-am-frustrated-post-got-removed-for-self-promo-tried-t/`
