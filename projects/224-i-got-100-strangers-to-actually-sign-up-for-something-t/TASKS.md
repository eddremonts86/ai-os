# TASKS.md — I got 100 strangers to actually sign up for something that doesn't exist yet

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/274-i-got-100-strangers-to-actually-sign-up-for-something-t/`
