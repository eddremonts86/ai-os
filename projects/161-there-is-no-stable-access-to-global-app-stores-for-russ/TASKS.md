# TASKS.md — There is no stable access to global app stores for Russian developers

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/161-there-is-no-stable-access-to-global-app-stores-for-russ/`
