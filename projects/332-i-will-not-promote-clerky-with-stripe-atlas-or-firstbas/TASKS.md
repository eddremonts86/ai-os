# TASKS.md — [I will not promote] Clerky with Stripe Atlas or Firstbase ?

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/332-i-will-not-promote-clerky-with-stripe-atlas-or-firstbas/`
