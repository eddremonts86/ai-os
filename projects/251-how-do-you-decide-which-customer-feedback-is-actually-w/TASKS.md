# TASKS.md — How do you decide which customer feedback is actually worth acting on?

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/251-how-do-you-decide-which-customer-feedback-is-actually-w/`
