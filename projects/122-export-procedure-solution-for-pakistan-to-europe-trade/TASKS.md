# TASKS.md — Export procedure solution for Pakistan to Europe trade

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/122-export-procedure-solution-for-pakistan-to-europe-trade/`
