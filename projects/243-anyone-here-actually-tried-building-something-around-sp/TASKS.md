# TASKS.md — anyone here actually tried building something around sports betting data?

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/293-anyone-here-actually-tried-building-something-around-sp/`
