# TASKS.md — Live threat monitoring for SOC teams with incident visualization and prioritization

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/150-live-threat-monitoring-for-soc-teams-with-incident-visu/`
