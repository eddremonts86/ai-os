# TASKS.md — : Looking for 10 people who need a deck walkthrough ready this week (no camera)

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/263-looking-for-10-people-who-need-a-deck-walkthrough-ready/`
