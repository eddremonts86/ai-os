# PLAN.md — I built a webcam ASL coach that grades your hand shape in real time — now testing whether the idea is even viable as a profitable product (its competitor is free)
