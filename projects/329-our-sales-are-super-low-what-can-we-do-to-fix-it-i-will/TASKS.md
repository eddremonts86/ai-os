# TASKS.md — Our sales are super low, what can we do to fix it? - I will not promote

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/329-our-sales-are-super-low-what-can-we-do-to-fix-it-i-will/`
