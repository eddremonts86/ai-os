# TASKS.md — I've manually submitted startups to 220+ directories. Only about 15 mattered.

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/267-ive-manually-submitted-startups-to-220-directories-only/`
