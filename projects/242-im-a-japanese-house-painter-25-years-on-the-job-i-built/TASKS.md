# TASKS.md — I'm a Japanese house painter (25 years on the job). I built a Zen fart-meditation app with AI in one day.

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/292-im-a-japanese-house-painter-25-years-on-the-job-i-built/`
