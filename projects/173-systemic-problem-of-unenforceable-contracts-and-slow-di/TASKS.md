# TASKS.md — Systemic problem of unenforceable contracts and slow dispute resolution

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/173-systemic-problem-of-unenforceable-contracts-and-slow-di/`
