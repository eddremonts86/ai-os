# TASKS.md — Search for an AI tool to create high-quality and natural-looking animation

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/138-search-for-an-ai-tool-to-create-high-quality-and-natura/`
