# TASKS.md — Built a battle-tested PRD Playbook in Notion for Product Managers (Guide + 3 Flexible Templates + Case Study) 🚀

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/275-built-a-battle-tested-prd-playbook-in-notion-for-produc/`
