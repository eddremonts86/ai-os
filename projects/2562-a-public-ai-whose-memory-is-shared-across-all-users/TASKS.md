---
id: "2562"
slug: a-public-ai-whose-memory-is-shared-across-all-users
title: A public AI whose memory is shared across all users
status: draft
source:
  name: manual
...
- [ ] Copiar `edd-app-template` → `apps/2562-a-public-ai-whose-memory-is-shared-across-all-users/`
