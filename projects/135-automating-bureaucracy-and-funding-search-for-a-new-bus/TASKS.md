# TASKS.md — Automating bureaucracy and funding search for a new business

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/135-automating-bureaucracy-and-funding-search-for-a-new-bus/`
