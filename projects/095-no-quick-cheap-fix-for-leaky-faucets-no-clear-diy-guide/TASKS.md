# TASKS.md — No quick, cheap fix for leaky faucets: no clear DIY guide or affordable plumber

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/095-no-quick-cheap-fix-for-leaky-faucets-no-clear-diy-guide/`
