# TASKS.md — We've built six no-signup cognitive practice demos — looking for honest onboarding feedback

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/290-weve-built-six-no-signup-cognitive-practice-demos-looki/`
