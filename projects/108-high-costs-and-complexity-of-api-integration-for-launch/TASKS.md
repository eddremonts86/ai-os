# TASKS.md — High costs and complexity of API integration for launching a travel website

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/108-high-costs-and-complexity-of-api-integration-for-launch/`
