# TASKS.md — Need for instant notifications about discounts at «Vkusvill» and «Perekrestok»

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/186-need-for-instant-notifications-about-discounts-at-vkusv/`
