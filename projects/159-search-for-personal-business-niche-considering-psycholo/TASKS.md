# TASKS.md — Search for personal business niche considering psychological barriers

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/159-search-for-personal-business-niche-considering-psycholo/`
