# TASKS.md — Multi agent coding almost shipped a billing bug for us

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/258-multi-agent-coding-almost-shipped-a-billing-bug-for-us/`
