# TASKS.md — There is no effective tool for researching high-margin and small e-commerce products

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/115-there-is-no-effective-tool-for-researching-high-margin-/`
