# TASKS.md — Problem of entering the AI automation market without technical experience

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/124-problem-of-entering-the-ai-automation-market-without-te/`
