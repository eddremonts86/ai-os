# TASKS.md — Need to withdraw cash from credit card without high fees

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/169-need-to-withdraw-cash-from-credit-card-without-high-fee/`
