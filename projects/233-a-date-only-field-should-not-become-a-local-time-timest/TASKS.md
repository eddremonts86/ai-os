# TASKS.md — A date-only field should not become a local-time timestamp

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/283-a-date-only-field-should-not-become-a-local-time-timest/`
