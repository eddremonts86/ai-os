# TASKS.md — I built a resume tool that tailors your CV to each job description. Looking for honest feedback

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/255-i-built-a-resume-tool-that-tailors-your-cv-to-each-job-/`
