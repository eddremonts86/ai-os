# TASKS.md — Problem with choosing a business niche in the local market

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/141-problem-with-choosing-a-business-niche-in-the-local-mar/`
