# TASKS.md — Image-based furniture and materials search service for designers

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/125-image-based-furniture-and-materials-search-service-for-/`
