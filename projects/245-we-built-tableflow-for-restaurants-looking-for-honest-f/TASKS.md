# TASKS.md — We built TableFlow for restaurants — looking for honest feedback from restaurant owners

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/295-we-built-tableflow-for-restaurants-looking-for-honest-f/`
