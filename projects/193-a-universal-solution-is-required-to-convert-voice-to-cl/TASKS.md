# TASKS.md — A universal solution is required to convert voice to clear text

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/193-a-universal-solution-is-required-to-convert-voice-to-cl/`
