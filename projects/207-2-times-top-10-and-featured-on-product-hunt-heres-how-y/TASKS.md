# TASKS.md — 2 times Top 10 and featured on Product Hunt - here's how you too can do it

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/257-2-times-top-10-and-featured-on-product-hunt-heres-how-y/`
