# TASKS.md — CTO offer at a pre-traction startup, but the pay is below my current stable job. Red flag? I will not promote

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/292-cto-offer-at-a-pre-traction-startup-but-the-pay-is-belo/`
