# TASKS.md — my little clock app just got a lifetime customer from Germany 🇩🇪

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/254-my-little-clock-app-just-got-a-lifetime-customer-from-g/`
