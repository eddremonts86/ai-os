# TASKS.md — A teacher needs a specialized «ChatGPT for video editing»

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/110-a-teacher-needs-a-specialized-chatgpt-for-video-editing/`
