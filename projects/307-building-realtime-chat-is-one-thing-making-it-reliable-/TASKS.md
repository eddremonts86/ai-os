# TASKS.md — Building realtime chat is one thing. Making it reliable is the hard part.

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/307-building-realtime-chat-is-one-thing-making-it-reliable-/`
