# TASKS.md — I scope SaaS platforms. Here is the exact framework I use to stop founders from wasting $10k+ on devs building the wrong features.

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/314-i-scope-saas-platforms-here-is-the-exact-framework-i-us/`
