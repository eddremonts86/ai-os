# TASKS.md — Solo founder building FetchSandbox, no network. How are you actually getting VC intros?

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/252-solo-founder-building-fetchsandbox-no-network-how-are-y/`
