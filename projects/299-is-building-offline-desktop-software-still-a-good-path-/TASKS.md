# TASKS.md — Is building offline desktop software still a good path in 2026? (I will not promote)

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/299-is-building-offline-desktop-software-still-a-good-path-/`
