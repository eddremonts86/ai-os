# TASKS.md — Difficulty finding relevant respondents for b2b research

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/165-difficulty-finding-relevant-respondents-for-b2b-researc/`
