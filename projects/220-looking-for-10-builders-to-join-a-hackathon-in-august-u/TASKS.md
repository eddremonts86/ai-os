# TASKS.md — Looking for 10 builders to join a hackathon in August, up to $10k in cash.

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/270-looking-for-10-builders-to-join-a-hackathon-in-august-u/`
