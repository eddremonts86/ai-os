# TASKS.md — No orders without a portfolio: a beginner freelancer's problem

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/198-no-orders-without-a-portfolio-a-beginner-freelancers-pr/`
