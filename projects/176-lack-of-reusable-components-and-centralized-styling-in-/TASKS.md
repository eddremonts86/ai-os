# TASKS.md — Lack of reusable components and centralized styling in Tilda

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/176-lack-of-reusable-components-and-centralized-styling-in-/`
