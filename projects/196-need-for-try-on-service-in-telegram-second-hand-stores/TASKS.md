# TASKS.md — Need for try-on service in Telegram second-hand stores

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/196-need-for-try-on-service-in-telegram-second-hand-stores/`
