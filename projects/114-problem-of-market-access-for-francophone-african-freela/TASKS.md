# TASKS.md — Problem of market access for francophone African freelancers

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/114-problem-of-market-access-for-francophone-african-freela/`
