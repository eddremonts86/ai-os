# TASKS.md — Which of these models gets us to start earning right away? i will not promote

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/297-which-of-these-models-gets-us-to-start-earning-right-aw/`
