# TASKS.md — How long do you spend building a first-meeting deck for one account?

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/309-how-long-do-you-spend-building-a-first-meeting-deck-for/`
