# TASKS.md — What is the biggest challenge you’re facing while building your startup? I will not promote

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/289-what-is-the-biggest-challenge-youre-facing-while-buildi/`
