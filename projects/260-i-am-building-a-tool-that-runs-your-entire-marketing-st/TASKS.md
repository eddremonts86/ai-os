# TASKS.md — I am building a tool that runs your entire marketing stack with AI, not just SEO

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/260-i-am-building-a-tool-that-runs-your-entire-marketing-st/`
