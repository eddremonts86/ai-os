# TASKS.md — The problem of lacking effective rescue robots for disaster situations

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/147-the-problem-of-lacking-effective-rescue-robots-for-disa/`
