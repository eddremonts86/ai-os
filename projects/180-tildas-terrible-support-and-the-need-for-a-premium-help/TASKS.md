# TASKS.md — Tilda's terrible support and the need for a premium help service

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/180-tildas-terrible-support-and-the-need-for-a-premium-help/`
