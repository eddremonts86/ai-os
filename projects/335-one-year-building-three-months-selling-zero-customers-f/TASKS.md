# TASKS.md — One year building, three months selling, zero customers. Frustrated and exhausted - where did I go wrong? i will not promote

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/335-one-year-building-three-months-selling-zero-customers-f/`
