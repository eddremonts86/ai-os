# TASKS.md — Need a simple alternative to Meta Ads after Andromeda update

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/140-need-a-simple-alternative-to-meta-ads-after-andromeda-u/`
