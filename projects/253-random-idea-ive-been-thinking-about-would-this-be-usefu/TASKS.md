# TASKS.md — Random idea I've been thinking about, would this be useful?

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/253-random-idea-ive-been-thinking-about-would-this-be-usefu/`
