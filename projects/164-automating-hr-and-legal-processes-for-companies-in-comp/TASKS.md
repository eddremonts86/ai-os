# TASKS.md — Automating HR and legal processes for companies, in compliance with the Russian Labor Code

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/164-automating-hr-and-legal-processes-for-companies-in-comp/`
