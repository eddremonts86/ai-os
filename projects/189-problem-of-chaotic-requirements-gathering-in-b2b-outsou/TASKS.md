# TASKS.md — Problem of chaotic requirements gathering in b2b outsourcing

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/189-problem-of-chaotic-requirements-gathering-in-b2b-outsou/`
