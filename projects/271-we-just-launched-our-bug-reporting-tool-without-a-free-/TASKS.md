# TASKS.md — We just launched our bug-reporting tool without a free trial

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/271-we-just-launched-our-bug-reporting-tool-without-a-free-/`
