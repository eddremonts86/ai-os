# TASKS.md — It's not possible to automatically create a diet plan from video recipes

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/163-its-not-possible-to-automatically-create-a-diet-plan-fr/`
