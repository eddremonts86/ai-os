...
- [ ] Read the source at `https://www.reddit.com/r/SaaS/comments/1vnwt0k/when_do_u_give_up_bro/` and quote the original problem statement into a `source-quote.md` for traceability.
- [ ] Create the project folder under `apps/455-when-do-u-give-up-bro/` (or per the chosen deployment target).
...
- [ ] Run a single end-to-end smoke test of the 455-when-do-u-give-up-bro MVP against the source post's stated use case.
