# TASKS.md — Swipe-to-vote app for deciding where to eat - finally ended the food debate with my wife!

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/300-swipe-to-vote-app-for-deciding-where-to-eat-finally-end/`
