# TASKS.md — Problem of managing type 1 diabetes without AI assistance

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/130-problem-of-managing-type-1-diabetes-without-ai-assistan/`
