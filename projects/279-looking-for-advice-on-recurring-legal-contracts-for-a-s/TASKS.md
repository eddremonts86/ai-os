# TASKS.md — Looking for advice on recurring legal contracts for a small US-based digital marketplace (I will not promote)

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/279-looking-for-advice-on-recurring-legal-contracts-for-a-s/`
