# TASKS.md — Difficulty finding effective marketers for a construction business

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/175-difficulty-finding-effective-marketers-for-a-constructi/`
