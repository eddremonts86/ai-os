# TASKS.md — Problem of finding clients for AI solution implementation in Europe and Eastern Europe

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/133-problem-of-finding-clients-for-ai-solution-implementati/`
