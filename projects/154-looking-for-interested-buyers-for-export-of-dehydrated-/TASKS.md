# TASKS.md — Looking for interested buyers for export of dehydrated products from India

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/154-looking-for-interested-buyers-for-export-of-dehydrated-/`
