# TASKS.md — Automated submission of utility meter readings to multiple management companies

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/170-automated-submission-of-utility-meter-readings-to-multi/`
