# TASKS.md — I built a command center for teams running coding agents — BYOK, persistent sessions, agent mesh

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/278-i-built-a-command-center-for-teams-running-coding-agent/`
