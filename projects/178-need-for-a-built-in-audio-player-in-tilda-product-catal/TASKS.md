# TASKS.md — Need for a built-in audio player in tilda product catalog

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/178-need-for-a-built-in-audio-player-in-tilda-product-catal/`
