# TASKS.md — Update: 3,080 users / 2 trials → 5,561 users / 59 trials. I tested forcing users into Premium, free still won. (I will not promote)

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/277-update-3080-users-2-trials-5561-users-59-trials-i-teste/`
