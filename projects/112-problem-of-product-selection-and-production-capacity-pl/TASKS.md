# TASKS.md — Problem of product selection and production capacity planning

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/112-problem-of-product-selection-and-production-capacity-pl/`
