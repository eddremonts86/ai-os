# TASKS.md — building saas got 10x easier. getting someone to care somehow got 10x harder. so we built this.

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/256-building-saas-got-10x-easier-getting-someone-to-care-so/`
