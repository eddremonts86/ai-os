# TASKS.md — Got rejected by Paddle twice with the exact same email. Still not sure what I did wrong .

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/273-got-rejected-by-paddle-twice-with-the-exact-same-email-/`
