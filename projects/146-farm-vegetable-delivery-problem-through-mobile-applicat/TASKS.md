# TASKS.md — Farm vegetable delivery problem through mobile application

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/146-farm-vegetable-delivery-problem-through-mobile-applicat/`
