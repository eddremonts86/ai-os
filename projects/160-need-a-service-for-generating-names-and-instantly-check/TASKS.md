# TASKS.md — Need a service for generating names and instantly checking domain availability

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/160-need-a-service-for-generating-names-and-instantly-check/`
