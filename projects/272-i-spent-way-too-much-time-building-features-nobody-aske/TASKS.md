# TASKS.md — I spent way too much time building features nobody asked for

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/272-i-spent-way-too-much-time-building-features-nobody-aske/`
