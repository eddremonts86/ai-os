# TASKS.md — Do multi-app long horizon tasks on frontier models for free!

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/276-do-multi-app-long-horizon-tasks-on-frontier-models-for-/`
