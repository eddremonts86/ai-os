...
- [ ] Copiar `edd-app-template` → `apps/449-how-do-i-turn-free-users-into-paying-users/`
...
- [ ] Cross-marketplace search MVP
- [ ] Curated drops
- [ ] Seller-side listing tool

## Phase 2: Deploy

- [ ] Confirm the chosen deployment target for the stack (Next.js, TypeScript, PostgreSQL) and set the prod-equivalent env vars.
- [ ] Run a single end-to-end smoke test of the 449-how-do-i-turn-free-users-into-payin MVP against the source post's stated use case.
