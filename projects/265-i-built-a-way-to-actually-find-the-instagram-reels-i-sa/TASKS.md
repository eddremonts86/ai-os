# TASKS.md — I built a way to actually find the Instagram Reels I save

## Phase 0: Scaffold

- [ ] Crear carpeta del proyecto en `apps/`
- [ ] Inicializar repo git
- [ ] Copiar `edd-app-template` → `apps/265-i-built-a-way-to-actually-find-the-instagram-reels-i-sa/`
