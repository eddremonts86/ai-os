...
- [ ] Copiar `edd-app-template` → `apps/430-looking-for-teammates-for-pitch-comps-i-will-not-promot/`
...
- [ ] Define skill taxonomy and profile schema
- [ ] Email-domain verification flow
- [ ] Skill + deadline search UI
- [ ] Handshake + chat (Supabase realtime) flow

## Phase 2: Deploy

- [ ] Confirm the chosen deployment target for the stack (Next.js, TypeScript, PostgreSQL) and set the prod-equivalent env vars.
- [ ] Run a single end-to-end smoke test of the 430-looking-for-teammates-for-pitch-com MVP against the source post's stated use case.
