...
- [ ] Copiar `edd-app-template` → `apps/490-i-keep-missing-my-favorite-farmers-market-vendorswould-/`
...
- [ ] Run a single end-to-end smoke test of the 490-i-keep-missing-my-favorite-farmers- MVP against the source post's stated use case.
