...
- [ ] Read the source at `https://www.reddit.com/r/SideProject/comments/1vnyun5/built_and_nba_roster_building_game_with_a_salary/` and quote the original problem statement into a `source-quote.md` for traceability.
- [ ] Create the project folder under `apps/502-built-and-nba-roster-building-game-with-/` (or per the chosen deployment target).
...
- [ ] Run a single end-to-end smoke test of the 502-built-and-nba-roster-building-game- MVP against the source post's stated use case.
