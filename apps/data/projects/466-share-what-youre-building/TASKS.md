...
- [ ] Read the source at `https://www.reddit.com/r/indiehackers/comments/1vn7o6e/share_what_youre_building/` and quote the original problem statement into a `source-quote.md` for traceability.
- [ ] Create the project folder under `apps/466-share-what-you-re-building/` (or per the chosen deployment target).
...
- [ ] Run a single end-to-end smoke test of the 466-share-what-you-re-building MVP against the source post's stated use case.
