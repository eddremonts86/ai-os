...
- [ ] Copiar `edd-app-template` → `apps/458-i-dont-know-why-i-still-have-0-tenants/`
...
- [ ] Run a single end-to-end smoke test of the 458-i-don-t-know-why-i-still-have-0-ten MVP against the source post's stated use case.
