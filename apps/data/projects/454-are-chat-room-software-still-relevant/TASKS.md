...
- [ ] Copiar `edd-app-template` → `apps/454-are-chat-room-software-still-relevant/`
...
- [ ] Run a single end-to-end smoke test of the 454-are-chat-room-software-still-releva MVP against the source post's stated use case.
