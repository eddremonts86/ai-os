...
- [ ] Copiar `edd-app-template` → `apps/440-stuck-on-how-to-get-customers-for-my-saas/`
...
- [ ] Write 30 tasks with definitions of done
- [ ] Progress tracker + reminders
- [ ] Public anonymised task log
- [ ] Stripe paid tier

## Phase 2: Deploy

- [ ] Confirm the chosen deployment target for the stack (Next.js, TypeScript, PostgreSQL) and set the prod-equivalent env vars.
- [ ] Run a single end-to-end smoke test of the 440-stuck-on-how-to-get-customers-for-m MVP against the source post's stated use case.
