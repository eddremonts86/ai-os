...
- [ ] Copiar `edd-app-template` → `apps/244-a-beginner-in-online-business-needs-not-a-course-but-a-/`
...
- [ ] Intake interview flow (15-minute, branching)
- [ ] GPT-4o plan generation with 90-day structure
- [ ] Daily "today's step" surface in web app
- [ ] Weekly check-in flow that updates plan based on actual progress
- [ ] Stripe subscription billing
- [ ] Resend transactional email for weekly check-in
- [ ] React Native mobile shell
- [ ] Admin dashboard for plan-quality review

## Phase 2: Deploy

- [ ] Confirm the chosen deployment target for the stack (Next.js 14, TypeScript, PostgreSQL) and set the prod-equivalent env vars.
- [ ] Run a single end-to-end smoke test of the 244-a-beginner-in-online-business-needs MVP against the source post's stated use case.
