...
- [ ] Read the source at `https://www.reddit.com/r/indiehackers/comments/1vi2qdv/solo_founder_building_fetchsandbox_no_network_how/` and quote the original problem statement into a `source-quote.md` for traceability.
- [ ] Create the project folder under `apps/474-solo-founder-building-fetchsandbox-no-ne/` (or per the chosen deployment target).
...
- [ ] Run a single end-to-end smoke test of the 474-solo-founder-building-fetchsandbox- MVP against the source post's stated use case.
