...
Design direction for the MVP at `https://problemhunt.pro/en/business/24mf80ltt1-the-owner-of-a-tech-agency-hasnt-` follows the constraints in `010-.../SPEC.md` and the chosen stack (Next.js, Postgres, Porkbun API). The visual language is intentionally narrow: a single primary surface, a single accent, and density tuned for the primary user in Colombia.
