...
- [ ] Copiar `edd-app-template` → `apps/274-saas-founders-lack-a-platform-for-finding-partners-and-/`
...
- [ ] Next.js founder profile and partner-matching
- [ ] Postgres schema: founders, partners, campaigns, attribution
- [ ] Joint-campaign editor (budget split, creative split, timeline)
- [ ] Attribution split dashboard
- [ ] Stripe Connect revenue split
- [ ] GPT-4o-mini matching and creative drafting
...
- [ ] Run a single end-to-end smoke test of the 274-saas-founders-lack-a-platform-for-f MVP against the source post's stated use case.
