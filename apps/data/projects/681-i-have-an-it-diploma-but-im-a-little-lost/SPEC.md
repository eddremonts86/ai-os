...
## Problem
 Tbh I was not the most studious person but I do understand the basics of html css js, databases and very rough backend. So I tried multiple times to build my own web app from scratch without following some kinda tutorial but I always get stuck at some portion of it and get confused. I'd like to relearn everything so I have a stronger fundamental so I went to YouTube and searched full stack and web app roadmaps and whatnot. But it's so overwhelming, can someone simplify the minimum tech stack to build a working Saas with actual users? And any resources would be much appreciated, sorry if this is considered a newbie post submitted by /u/Historical_Song7703 [link] [comments]
